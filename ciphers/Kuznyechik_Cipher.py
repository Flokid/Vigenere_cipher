...
# Шифрование текста
def decrypt(text, K):
    # print("Входной текст:", text)  # Вывод входного текста, чтобы увидеть, что передается
    textArray = []
    for i in range(int(len(text) / 32)):
        textArray.append(text[i * 32 : i * 32 + 32])

    # print("Массив текста:", textArray)  # Вывод массива текста, чтобы убедиться, что он заполнен правильно
    ...
    for j in textArray:
        ...
        # print("Промежуточный расшифрованный текст:", textDecrypt)
